...
- Prompt ID: `24c325d3-59a4-419b-aade-09b2e165053e`
- Submitted At: `2026-05-05T14:36:23.978776+00:00`
- Completed At: `2026-05-05T14:36:29.352267+00:00`
...
Execution still blocks before image generation, so this pass cannot verify anchor-face retention, scene adaptation, wardrobe adaptation, or realism.
The workflow is now being reported truthfully as a terminal error, and the remaining blocker is the same FLUX runtime incompatibility at SamplerCustomAdvanced where forward_orig() rejects the timestep_zero_index argument.

## Recommended Fixes

Resolve the ComfyUI core, FLUX model path, and PuLID-Flux/custom sampler version mismatch that is still causing the live runtime failure.
After runtime alignment, re-run this exact default QA path and confirm the run produces a downloadable output artifact and a reviewable image.
Keep the same workflow, anchor binding, and scene-reference path so the post-fix result remains directly comparable across QA runs.

## Additional Notes

Gateway discovery, scene upload, and generation submission still work on the default path.
This run also confirms the repo-side harness and gateway logic now surface terminal execution errors explicitly instead of masking them as completed runs.

## Runtime Metadata

```json
{
  "prompt_id": "24c325d3-59a4-419b-aade-09b2e165053e",
  "workflow_name": "mumbai-yoga-anchor-faceid-v1.json",
  "client_id": "f8ff3c38-9fb9-4722-bdaf-3291d5a4541b",
  "status": "error",
  "submitted_at": "2026-05-05T14:36:23.978776+00:00",
  "completed_at": "2026-05-05T14:36:29.352267+00:00",
  "error_text": "forward_orig() got an unexpected keyword argument 'timestep_zero_index'",
  "overrides": {
    "filename_prefix": "qa-mumbai-yoga-anchor-faceid-v1.json",
    "scene_reference_image": "684168240_18577405549021710_2095548451815178247_n_b3792e2b.jpg"
  },
  "outputs": [],
  "history": {
    "24c325d3-59a4-419b-aade-09b2e165053e": {
      "meta": {},
      "outputs": {},
      "prompt": [
        6,
        "24c325d3-59a4-419b-aade-09b2e165053e",
        {
          ...
          "65": {
            "class_type": "LoadImage",
            "inputs": {
              "image": "684168240_18577405549021710_2095548451815178247_n_b3792e2b.jpg",
              "upload": "image"
            }
          },
          "66": {
