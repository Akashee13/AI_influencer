...
- Prompt ID: `966f71ee-9685-4b37-a4d5-43085c40cf95`
- Submitted At: `2026-05-05T14:25:17.341053+00:00`
- Completed At: `2026-05-05T14:25:22.711855+00:00`
...
Execution blocked before image generation again, so this rerun still cannot verify anchor-face retention, scene adaptation, wardrobe adaptation, or realism.
The default face-locked FLUX workflow remains runtime-incompatible at SamplerCustomAdvanced / FLUX model execution because forward_orig() still rejects the timestep_zero_index argument.

## Recommended Fixes

Resolve the ComfyUI core, FLUX model path, and PuLID-Flux/custom sampler version mismatch before using this workflow for image QA.
After aligning the runtime stack or adjusting the workflow path, re-run this exact default QA pass and confirm the run produces a downloadable output artifact.
Keep the same workflow, anchor binding, and scene-reference path during validation so the post-fix result is directly comparable to this failing rerun.

## Additional Notes

Gateway discovery, scene upload, and generation submission are still working on the default path.
This rerun reproduces the same runtime compatibility gap as the earlier report and supports the new Spec Kit package for runtime repair.

## Runtime Metadata

```json
{
  "prompt_id": "966f71ee-9685-4b37-a4d5-43085c40cf95",
  "workflow_name": "mumbai-yoga-anchor-faceid-v1.json",
  "client_id": "59b3a96f-1433-406d-b3dc-4da6f021b544",
  "status": "completed",
  "submitted_at": "2026-05-05T14:25:17.341053+00:00",
  "completed_at": "2026-05-05T14:25:22.711855+00:00",
  "error_text": null,
  "overrides": {
    "filename_prefix": "qa-mumbai-yoga-anchor-faceid-v1.json",
    "scene_reference_image": "684168240_18577405549021710_2095548451815178247_n_d69ef4fe.jpg"
  },
  "outputs": [],
  "history": {
    "966f71ee-9685-4b37-a4d5-43085c40cf95": {
      "meta": {},
      "outputs": {},
      "prompt": [
        4,
        "966f71ee-9685-4b37-a4d5-43085c40cf95",
        {
          ...
          "65": {
            "class_type": "LoadImage",
            "inputs": {
              "image": "684168240_18577405549021710_2095548451815178247_n_d69ef4fe.jpg",
              "upload": "image"
            }
          },
          "66": {
